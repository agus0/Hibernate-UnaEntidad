	...
	public class ClienteABM {
		...
		public Cliente traerCliente( long idCliente) {
			Cliente c= dao .traerCliente(idCliente); // implementar si c es null lanzar Exception
			return c;
		}
		
		public Cliente traerCliente( int dni){
			Cliente c= dao .traerCliente(dni); // implementar si c es null lanzar Exception
			return c;
		}
